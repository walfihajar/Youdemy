...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id_course'])) {
    ...
    $course = new Course($db, $courseId); // Pass the PDO connection and course ID
    if ($course->delete()) {
...
$courses = Course::showByTeacherWithDetails($db, $teacherId); // Pass the PDO connection and teacher ID
?>
